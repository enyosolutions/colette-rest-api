...
class MeetupService
{
    const BASE = 'http://api.meetup.com/';
    ...
    public function init(array $parameters = array('key' => '7a7f4fb7a7c366504ad16574b7a'))
    {
    ...
    {
        return $this->get('/:urlname/boards', $parameters)->results;
    }

    public function getDiscussions(array $parameters = array())
    {
        return $this->get('/:urlname/boards/:bid/discussions', $parameters)->results;
    }

    public function getMembers(array $parameters = array())
    {
        return $this->get('/2/members', $parameters)->results;
    }

    public function getCategories(array $parameters = array())
    {
        return $this->get('/2/categories', $parameters)->results;
    }

    public function getCities(array $parameters = array())
    {
        return $this->get('/2/Cities', $parameters)->results;
    }

    public function getDashboards(array $parameters = array())
    {
        return $this->get('/dashboards', $parameters)->results;
    }

    public function getFeeds(array $parameters = array())
    {
        return $this->get('/activity', $parameters)->results;
    }

    public function getGroups(array $parameters = array())
    {
        return $this->get('/2/groups', $parameters)->results;
    }

    public function getMeta(array $parameters = array())
    {
        return $this->get('/status', $parameters)->results;
    }

    public function getNotifications(array $parameters = array())
    {
        return $this->get('/notifications', $parameters)->results;
    }

    public function getOembed(array $parameters = array())
    {
        return $this->get('/oembed', $parameters)->results;
    }

    public function getProfiles(array $parameters = array())
    {
        return $this->get('/2/profiles', $parameters)->results;
    }
    ...
    {
        return $this->get('/2/topic_categories', $parameters)->results;
    }
